...
class CalendarDetailsPageByYearlyControllerTest {
    ...
    @Autowired
    public CalendarDetailsPageByYearlyControllerTest(CalendarDetailsPageController calendarDetailsPageController, LoginInterceptor loginInterceptor, PassBookMapper passBookMapper, PassBookKindsMapper passBookKindsMapper) {
    ...
    void 년별_출력() throws Exception {
        ...
        //when
        MockHttpServletRequestBuilder builder = get("/calendar/details/year")
                .session(session)
                .param("date", "");
        ...
        mvc.perform(builder)
                ...
                .andExpect(model().attributeExists("passBookListYearly"))
                .andExpect(forwardedUrl("thymeleaf/ledger/main_page/calendar-details-year"));

    }

    @Test
    void 년별_출력_세션없음() throws Exception {
        //given
        passBookKindsMapper.add("test", "test", "0000-1111-2222");
        int pbKindsNum = passBookKindsMapper.selectAllByUserId("test").get(0).getNum();
